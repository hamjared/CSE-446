...
partial void AfterInitializeComponent();
        ...
        private string FindResource() {
            ...
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                ...
                if ((resource.Contains(".WorkflowMessagingApplication.UserLoginService.IService1.CreateUser.g.xaml") || resource.Equals("WorkflowMessagingApplication.UserLoginService.IService1.CreateUser.g.xaml"))) {
                    return resource;
                }
            }
