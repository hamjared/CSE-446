...
namespace LoginServiceWFConractFirst {
    ...
    public partial class LoginActivity : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
        ...
        private System.Activities.OutArgument<bool> _wasSuccesfullLogin;
...
partial void AfterInitializeComponent();
        ...
        public System.Activities.OutArgument<bool> wasSuccesfullLogin {
            get {
                return this._wasSuccesfullLogin;
            }
            set {
                this._wasSuccesfullLogin = value;
            }
        }
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(LoginActivity).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(LoginActivity));
        ...
        private string FindResource() {
            string[] resources = typeof(LoginActivity).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".LoginActivity.g.xaml") || resource.Equals("LoginActivity.g.xaml"))) {
                    return resource;
                }
            }
